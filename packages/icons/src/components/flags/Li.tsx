    ...
    <G mask="url(#LI_svg__a)">
      ...
      <G mask="url(#LI_svg__b)">
        ...
        <Path
          fill="#000"
          fillRule="evenodd"
          d="M4.798 11.053s1.207.751 4.003.751c2.796 0 4.28-.75 4.28-.75S10.89 9.777 8.929 9.777c-1.96 0-4.13 1.275-4.13 1.275z"
          clipRule="evenodd"
        />
        <Path
          fill="#FFD83D"
          stroke="#000"
          strokeWidth={0.5}
          d="M4.87 6.742l-.216.126.073.124h8.652l.055-.174-.238-.076.238.075h0l.001-.002.002-.006.006-.02.02-.071a5.192 5.192 0 00.17-1.102c.026-.648-.08-1.493-.71-2.04-.64-.558-1.454-.471-2.156-.296-.24.06-.483.135-.71.205l-.311.095c-.322.094-.59.156-.805.156-.215 0-.451-.057-.729-.145-.084-.026-.173-.056-.266-.087-.2-.067-.416-.139-.633-.196-.66-.173-1.42-.239-2.262.239-.44.248-.69.594-.81.974-.116.372-.101.76-.04 1.102A4.11 4.11 0 004.6 6.764l.04.075.01.02.004.006v.002h.001l.217-.125z"
        />
        <Path
          fill="#FFD83D"
          stroke="#000"
