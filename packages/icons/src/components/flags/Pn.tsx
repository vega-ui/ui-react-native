  ...
  <Svg fill="none" viewBox="0 0 32 24" width={24} height={24} {...props}>
    ...
    <G mask="url(#PN_svg__a)">
      ...
      <G mask="url(#PN_svg__b)">
        ...
        <G mask="url(#PN_svg__e)">
          <Path
            fill="#58A5FF"
            fillRule="evenodd"
            d="M24.652 15.024l-2.265 4.7 3.071-2.79 2.115 3.505v-5.415l-2.115 1.733-.806-1.733z"
            clipRule="evenodd"
          />
          <Path
            fill="#FFD018"
            d="M24.58 18.414a.169.169 0 01.338 0v3.018a.169.169 0 11-.338 0v-3.018z"
          />
          <Path
            fill="#FFD018"
            d="M23.992 19.158a.166.166 0 010-.332h1.528a.166.166 0 110 .332h-1.527zm.824 2.331l-.131.106c-.193-.234-.369-.347-.524-.347-.229 0-.415-.19-.567-.553l.156-.064c.129.306.268.45.411.45.216 0 .433.138.655.408z"
          />
          <Path
            fill="#FFD018"
            fillRule="evenodd"
            d="M23.443 20.12c0-.002-.002-.001-.002 0v.816c0 .002 0 .002.002.002l.614-.253a.002.002 0 000-.002l-.614-.564z"
            clipRule="evenodd"
          />
          <Path
            fill="#FFD018"
            d="M24.677 21.489l.13.106c.194-.234.37-.347.525-.347.229 0 .415-.19.566-.553l-.156-.064c-.128.306-.268.45-.41.45-.216 0-.433.138-.655.408z"
          />
          <Path
            fill="#FFD018"
            fillRule="evenodd"
            d="M26.05 20.12a.002.002 0 01.002 0v.816c0 .002 0 .002-.002.002l-.614-.253v-.002l.613-.564z"
            clipRule="evenodd"
          />
