...
const SvgTc = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 32 24" width={24} height={24} {...props}>
    ...
    <G mask="url(#TC_svg__a)">
      ...
      <G mask="url(#TC_svg__b)">
        <Path
          fill="#FECA00"
          fillRule="evenodd"
          stroke="#F7FCFF"
          strokeWidth={0.5}
          d="M21.047 10.033s.886 11.931 4.882 11.931c3.995 0 4.978-11.931 4.978-11.931h-9.86z"
          clipRule="evenodd"
        />
        <Path
          fill="#CF6900"
          fillRule="evenodd"
          d="M25.911 10.622l.147-.165.694.442c.1-.157.28-.23.53-.217l-.253-.386.206-.11.48.579.048.015-.122-.752.241-.028.158.974h.012a.43.43 0 01.223.085L28.447 10l.241.028-.122.752.048-.015.48-.579.206.11-.253.386c.25-.012.43.06.53.217l.694-.442.147.165-.762.485c.01.055.016.115.016.18v.113l1.05-.23.078.195-1.128.4v.136l1.07-.087.032.205-1.102.16v.236l1.104.183-.044.203-1.06-.159v2.299h-.163v-2.323l-.71-.106c-.08.562-.17 1.27-.158 1.526.013.253.202.361.334.438.103.059.172.098.098.171-.17.167-.596.327-1.021.327-.426 0-.846-.16-.937-.327-.016-.03-.014-.027 0-.01.068.077.4.457.426-.599a5.787 5.787 0 00-.169-1.502l-.552.082v2.323h-.163v-2.299l-1.06.159-.045-.203 1.105-.183v-.236l-1.102-.16.032-.205 1.07.087v-.136l-1.128-.4.077-.196 1.051.23v-.112a.92.92 0 01.016-.18l-.762-.485zm1.39 1.651l.01.034-.491.081v-.185l.482.07zm.011-.759l-.022.024-.47-.103v-.148c0-.03 0-.058.003-.084l.49.311zm.313-.31a3.033 3.033 0 00-.16.15l-.581-.371c.082-.142.242-.193.493-.156l.248.378zm1.07.257l.75-.478c-.082-.142-.243-.193-.493-.156l-.348.53a3.6 3.6 0 01.09.104zm.253.097l.558-.355a.989.989 0 01.003.084v.148l-.561.123zm.224.383l.337-.119v.092l-.337.027zm-.259.349l.596-.087v.185l-.596-.098zm-2.093-.468v.092l.336.027-.336-.119z"
          clipRule="evenodd"
        />
        <Path
          fill="#00A727"
          fillRule="evenodd"
          d="M24.878 15.843s-1.314 2.2-1.314 3.533c0 0 .895.71 2.435.71s2.332-.71 2.332-.71c-.433-1.58-1.171-3.533-1.171-3.533h-2.282z"
          clipRule="evenodd"
        />
        <Path
          fill="#E31D1C"
          fillRule="evenodd"
          d="M24.942 15.235a1.097 1.097 0 012.194 0v.75h-2.194v-.75z"
          clipRule="evenodd"
        />
        <Path
          fill="#FF927F"
