    ...
    <G mask="url(#AI_svg__a)">
      ...
      <G mask="url(#AI_svg__b)">
        <Path
          fill="#FBE625"
          fillRule="evenodd"
          d="M20.943 11.856l.003.35c.027 2.95.136 4.88.33 5.805.16.768.745 2.04 1.432 3.062.864 1.283 1.787 2.064 2.669 2.064.886 0 1.809-.726 2.669-1.936.706-.993 1.311-2.252 1.552-3.18.298-1.15.437-3.085.42-5.818l-.002-.347-.318.164a4.44 4.44 0 01-2.072.497c-.734 0-1.442-.219-2.128-.66l-.118-.076-.12.073c-.724.444-1.405.663-2.043.663-.646 0-1.296-.165-1.952-.498l-.322-.163zm.546 6.114c-.19-.907-.299-2.829-.326-5.765.686.348 1.371.522 2.054.522.683 0 1.403-.232 2.16-.696.721.464 1.47.696 2.249.696.777 0 1.503-.174 2.175-.522.017 2.716-.121 4.637-.414 5.764-.439 1.692-2.279 4.958-4.01 4.958-1.731 0-3.604-3.597-3.888-4.957z"
          clipRule="evenodd"
        />
        <Path
          fill="#F5FBFF"
        ...
        <G fillRule="evenodd" clipRule="evenodd" mask="url(#AI_svg__c)">
          <Path
            fill="#FF9800"
