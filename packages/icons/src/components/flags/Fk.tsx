  ...
  <Svg fill="none" viewBox="0 0 32 24" width={24} height={24} {...props}>
    ...
    <G mask="url(#FK_svg__a)">
      ...
      <G mask="url(#FK_svg__b)">
        ...
        <G mask="url(#FK_svg__c)">
          <Path
            fill="#E1E5E8"
            fillRule="evenodd"
            d="M24.522 13.587s-.395-.292-.564-.765c-.17-.473-.504-1.732-.504-1.841 0-.11-.446 0-.446 0s.006-.532.175-.532c.168 0 .174-.494.582-.37.408.125.729.58 1.145.58.415 0 2.153.133 2.433.133.279 0 1.015.59 1.015 1.031 0 .441-.2 1.1-.358 1.1-.158 0-.357.382-.657.255-.3-.126-1.017-.386-1.66-.256-.642.13-.773.048-.773.256 0 .208-.388.409-.388.409z"
            clipRule="evenodd"
          />
          <Path
            fill="#49801E"
            fillRule="evenodd"
            d="M23.6 13.279h5.155l-.887 1.147h-3.643L23.6 13.28z"
            clipRule="evenodd"
          />
          <Path
            stroke="#fff"
            strokeWidth={1.067}
            d="M23.533 18.296s.89.318 1.263.28c.413-.043.778-.513 1.053-.513.276 0 .805.47 1.217.513.373.038 1.1-.28 1.1-.28m-5.612-1.36c.308-.26.979-.28.979-.28s.89.319 1.263.28c.413-.043.778-.513 1.053-.513.276 0 .805.47 1.217.513.373.039 1.1-.28 1.1-.28s.406-.457.917.026"
          />
          <Path
            fill="#fff"
            d="M22.46 15.53l-.674-.827c.265-.215.709-.428 1.357-.663l.314-.015c.672.172 1.122.247 1.286.23.054-.005.145-.049.31-.159.471-.312.517-.337.796-.337.256 0 .308.024.842.313.1.053.136.072.19.098a.862.862 0 00.238.086c.128.013.386-.047.747-.193.47-.426 1.064-.382 1.576.084.341.311.615.562.822.754l-.725.782c-.204-.189-.476-.438-.815-.748-.135-.122-.106-.122-.166-.057l-.185.13c-.56.237-1.002.345-1.36.31a1.765 1.765 0 01-.594-.187 5.303 5.303 0 01-.235-.121c-.257-.14-.355-.185-.335-.185.045 0-.017.035-.206.16-.303.202-.514.304-.794.332-.308.031-.79-.043-1.494-.218-.458.173-.762.323-.894.43z"
          />
        </G>
        <Path
          stroke="#B85F3C"
          d="M22.963 18.394s.984.942.39 1.58c-.594.64-1.139.268-1.139.268m6.836-1.848s-.984.942-.39 1.58c.594.64 1.139.268 1.139.268"
        />
        <Path
          stroke="#CB8B73"
          d="M22.32 19.153s1.696 1.62 3.78 1.62c2.084 0 3.76-1.238 3.76-1.238"
        />
